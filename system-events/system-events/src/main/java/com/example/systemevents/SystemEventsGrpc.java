...
public final class SystemEventsGrpc {
  ...
  public static final io.grpc.MethodDescriptor<com.example.systemevents.SystemEventsOuterClass.Request,
      com.example.systemevents.SystemEventsOuterClass.Response> METHOD_START =
      io.grpc.MethodDescriptor.<com.example.systemevents.SystemEventsOuterClass.Request, com.example.systemevents.SystemEventsOuterClass.Response>newBuilder()
          .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
          .setFullMethodName(generateFullMethodName(
              "SystemEvents", "start"))
          .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
              com.example.systemevents.SystemEventsOuterClass.Request.getDefaultInstance()))
          .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
              com.example.systemevents.SystemEventsOuterClass.Response.getDefaultInstance()))
          .build();
  ...
  public static abstract class SystemEventsImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void start(com.example.systemevents.SystemEventsOuterClass.Request request,
        io.grpc.stub.StreamObserver<com.example.systemevents.SystemEventsOuterClass.Response> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                com.example.systemevents.SystemEventsOuterClass.Request,
                com.example.systemevents.SystemEventsOuterClass.Response>(
                  this, METHODID_START)))
          .build();
    }
  }
  ...
  public static final class SystemEventsBlockingStub extends io.grpc.stub.AbstractStub<SystemEventsBlockingStub> {
    ...
    /**
     */
    public com.example.systemevents.SystemEventsOuterClass.Response start(com.example.systemevents.SystemEventsOuterClass.Request request) {
  ...
  public static final class SystemEventsFutureStub extends io.grpc.stub.AbstractStub<SystemEventsFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.example.systemevents.SystemEventsOuterClass.Response> start(
        com.example.systemevents.SystemEventsOuterClass.Request request) {
  ...
  private static final class MethodHandlers<Req, Resp> implements
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_START:
          serviceImpl.start((com.example.systemevents.SystemEventsOuterClass.Request) request,
              (io.grpc.stub.StreamObserver<com.example.systemevents.SystemEventsOuterClass.Response>) responseObserver);
          break;
        default:
  ...
  private static final class SystemEventsDescriptorSupplier implements io.grpc.protobuf.ProtoFileDescriptorSupplier {
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.example.systemevents.SystemEventsOuterClass.getDescriptor();
    }
  }
